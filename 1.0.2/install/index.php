...
Class getsale_getsale extends CModule
{
    ...
    public function DoInstall()
    {
        ...
        RegisterModuleDependences("sale", "OnBasketAdd", $this->MODULE_ID, "CGetsaleGetsale", "updateCart", "100");
        RegisterModuleDependences("sale", "OnBasketUpdate", $this->MODULE_ID, "CGetsaleGetsale", "updateCart", "100");
        RegisterModuleDependences("sale", "OnSaleBasketSaved", $this->MODULE_ID, "CGetsaleGetsale", "newEventUpdateCart", "100");
        RegisterModuleDependences("sale", "OnBeforeBasketDelete", $this->MODULE_ID, "CGetsaleGetsale", "delFromCart", "100");
    ...
    public function DoUninstall()
    {
        ...
        UnRegisterModuleDependences("sale", "OnBasketAdd", $this->MODULE_ID, "CGetsaleGetsale", "updateCart");
        UnRegisterModuleDependences("sale", "OnBasketUpdate", $this->MODULE_ID, "CGetsaleGetsale", "updateCart");
        UnRegisterModuleDependences("sale", "OnSaleBasketSaved", $this->MODULE_ID, "CGetsaleGetsale", "newEventUpdateCart");
        UnRegisterModuleDependences("sale", "OnBeforeBasketDelete", $this->MODULE_ID, "CGetsaleGetsale", "delFromCart");
